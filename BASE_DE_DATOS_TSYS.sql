...
--
-- Servidor: localhost
-- Tiempo de generación: 10-06-2018 a las 21:19:18
...
CREATE TABLE IF NOT EXISTS `tb_contract` (
  `co_contract` int(11) NOT NULL,
  `tb_hours_available_co_dni_teacher` varchar(8) NOT NULL,
  ...
  `nu_latitude` bigint(20) DEFAULT NULL,
  `nu_longitude` bigint(20) DEFAULT NULL,
  `score_contract` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`tb_available_knowledge_co_avai_know`,`tb_hours_available_co_dni_teacher`,`tb_hours_available_co_hours_ava`,`co_contract`),
  KEY `tb_contract_tb_hours_available_FK` (`tb_hours_available_co_dni_teacher`,`tb_hours_available_co_hours_ava`),
...
CREATE TABLE IF NOT EXISTS `tb_teacher_detail_uni` (
  ...
  PRIMARY KEY (`tb_university_co_university`,`tb_user_teacher_co_dni_teacher`),
...
CREATE TABLE IF NOT EXISTS `tb_user_teacher` (
  ...
  `num_user_nu_latitude` bigint(20) DEFAULT NULL,
  `num_user_nu_longitude` bigint(20) DEFAULT NULL,
  `status_user` int(11) DEFAULT NULL,
  `prom_score` bigint(20) DEFAULT NULL,
...
ALTER TABLE `tb_contract`
  ...
  ADD CONSTRAINT `tb_contract_tb_hours_available_FK` FOREIGN KEY (`tb_hours_available_co_dni_teacher`, `tb_hours_available_co_hours_ava`) REFERENCES `tb_hours_available` (`tb_user_teacher_co_dni_teacher`, `co_hours_ava`);
